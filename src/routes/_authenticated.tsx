          ...
          {links.map((l) => {
            ...
            return (
              <Link 
                key={l.to} 
                to={l.to} 
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium transition ${active ? "bg-primary/10 text-primary" : "text-foreground/70 hover:bg-secondary"}`}
              >
            ...
            {links.map((l) => {
              ...
              return (
                <Link 
                  ...
                  to={l.to} 
                  aria-label={l.label} 
                  className={`flex items-center justify-center h-9 w-9 rounded-lg transition ${active ? "bg-primary/10 text-primary" : "text-foreground/70 hover:bg-secondary"}`}
                >
