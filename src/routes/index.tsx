...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "odontolink — Funis de vendas interativos para clínicas" },
      ...
      { property: "og:title", content: "odontolink — Funis de vendas interativos" },
          ...
          <div className="container mx-auto px-4 py-16 lg:py-24 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-muted-foreground max-w-xl">
                A <strong className="text-foreground">odontolink</strong> transforma tráfego em pacientes com <strong className="text-foreground">funis de vendas interativos</strong>, visualmente otimizados e centralizados em uma única plataforma.
              </p>
